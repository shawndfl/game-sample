...
bool LevelSquare::start() {
    ...
    if(bsk::ImageLoader::loadImage("assets/img/Bricks.png", img)) {
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, img.getWidth(), img.getHeight(), 0, GL_RGBA, GL_UNSIGNED_BYTE, img.getImageData());
...
/*************************************************/
void LevelSquare::update(bsk::Milliseconds dt) {
    // render
    // ------
...
/*************************************************/
void LevelSquare::resize(uint width, uint height) {

}

/*************************************************/
void LevelSquare::keyEvent(int key, int scancode, int action, int mods) {
}

/*************************************************/
void LevelSquare::dispose() {
}
